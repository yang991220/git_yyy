...
@Component
public class ItemFeignFallBackFactory implements FallbackFactory<TbItemFeign> {
    @Override
    public TbItemFeign create(Throwable throwable) {
        System.out.println("降级原因"+throwable.getMessage());
        return new TbItemFeign() {
            @Override
